...
from qaseio import rest
from qaseio.configuration import Configuration
from qaseio.exceptions import ApiTypeError, ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/3.0.0a1/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.delete_attachment  # this is an instance of the class Endpoint
        api_instance.delete_attachment()  # this invokes api_instance.delete_attachment.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_attachment.callable or self.callable in this class
